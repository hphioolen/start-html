...
function () {
  ...
  _createClass(Collapse, [{
    ...
    key: "_removePanelHeight",
    value: function _removePanelHeight(panel) {
      var contents = panel.querySelector("summary + *");
    ...
    key: "_afterOpen",
    value: function _afterOpen(panel) {
    ...
    key: "_afterClose",
    value: function _afterClose(panel) {
      var _this = this;
    ...
    key: "_endClose",
    value: function _endClose(panel) {
    ...
    key: "openSinglePanel",
    value: function openSinglePanel(panel) {
      var _this2 = this;
    ...
    value: function _attachEvents() {
      ...
      this._panels.forEach(function (panel) {
        ...
        var contents = panel.querySelector("summary + *"); // On panel open
        ...
        */
        ...
        var propToWatch = ''; // On panel finishing open/close animation
        ...
        contents.addEventListener("transitionend", function (e) {
          ...
          if (!propToWatch) propToWatch = e.propertyName; // If watched property matches currently animating property
    ...
    value: function init() {
      ...
      this._attachEvents(); // If accordion, open the first panel
...
var accordion = new Collapse(makeMePretty, {
  accordion: true
}).init(); // Toggle accordion behavior

document.querySelector("#accordion-toggle").addEventListener("change", function () {
  this.checked ? accordion.settings.accordion = false : accordion.settings.accordion = true;
